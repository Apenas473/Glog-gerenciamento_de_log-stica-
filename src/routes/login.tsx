...
import { Boxes, User, Truck, Building2, UserCog, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-background via-background to-accent/30">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-4">Escolha um perfil para entrar na demonstração</p>
        </div>
